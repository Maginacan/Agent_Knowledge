...
| 模式 | 双轴 | 拓扑本质 |
|------|------|----------|
| 上下文分诊 [[lession9-上下文分诊]] | 感知 × 路由 | Router 单点路由 |
| 语义压缩 [[lession10-语义压缩]] | 感知 × 链式 | Chain 三层级联 |
...
| 场景 | 原因 |
|------|------|
| 客服 Agent 接当前用户的工单上下文 | 已在 P1（[[lession9-上下文分诊]] 的工单分级）|
