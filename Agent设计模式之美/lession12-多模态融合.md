...
| 时长 | 25:05 |
| 发布日期 | 2026-06-12 |
| 前置讲 | [[lession11-渐进发现]] — 探索未知空间 |
| 后续讲 | [[lession13-记忆模块导论]] — 跨会话经验沉淀 |
...
>
> - 第 7 讲 [[lession9-上下文分诊]] — 学习哪些信息先进来
> - 第 8 讲 [[lession10-语义压缩]] — 进来以后怎么压缩
> - 第 9 讲 [[lession11-渐进发现]] — 不知道在哪儿的信息怎么探索
>
...
| 模式 | 处理什么 |
|------|----------|
| [[lession9-上下文分诊]] | 哪些 token 进来 |
| [[lession10-语义压缩]] | 进来后怎么压 |
| [[lession11-渐进发现]] | 怎么找 |
...
|------|------|------|
| 1 | **多模态融合**（本讲）| 先决定数据形态 |
| 2 | **[[lession9-上下文分诊]]** | 决定哪些信息靠近模型 |
| 3 | **[[lession10-语义压缩]]** | 长会话里的工作记忆 |
| 4 | **[[lession11-渐进发现]]** | 未知空间里的探索 |
