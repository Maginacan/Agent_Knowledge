...
| **多口径比较** | "小雪同时命中两版奖金政策，该按哪版算" | 几个口径都说得通 | [[lession19-并行探索\|并行探索]] |
| **迭代调查** | "月底总账差了 37 万，缺口从哪来" | 信息不足 | [[lession20-迭代假设验证\|迭代假设验证]] |
...
| `COT` | 主路径明确，中间步骤不能省 | [[lession17-思维链\|思维链]] |
| `PARALLEL` | 多个合理口径，需要并行比较 | [[lession19-并行探索\|并行探索]] |
| `ITERATIVE` | 信息不足，需要边查边修 | [[lession20-迭代假设验证\|迭代假设验证]] |
...
- **复杂度路由** = 分诊台
- **[[lession17-思维链|$2]]** = 对账诊室（一条链）
- **[[lession19-并行探索|$2]]** = 择优诊室（多路径）
- **[[lession20-迭代假设验证|$2]]** = 逼近根因诊室（多轮）
